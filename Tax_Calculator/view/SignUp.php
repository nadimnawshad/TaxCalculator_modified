            ...
            <div class="popUp-content">
                ...
                <div class="nav justify-content-center">
                    <ul class="row signUp_logIn_Button">
                        <li><button type="button" class="btn button " id="signUp_button">Add User</button></li>                                            
                        <li class="nav-item">
                ...
                <form action='SignUp.php' method='POST' class='form_style signUpForm signUpForm_new' id="signUp_Form">
                    ...
                    <input type='text' name='repassword' id='repassword' placeholder='Retype Password' >
