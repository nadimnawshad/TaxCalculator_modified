...
<section class="text-center">
	<form action='DeleteCategory.php' method='DELETE' class='form_style' >
		<label>* Category Name : </label><br>
        <input type='text' style="width: 15%;" name='categoryName' id='categoryName' placeholder='Category Name' >
        <p id='phoneValidation' class='errorMsg'></p>
		<input type="submit" value="Delete" class="btn button col-lg-1"
       style="padding: 1% 1%; margin: 2%;" onclick ="deleteCategory()" />
    </form>
	<span class="line"></span>
</section>
