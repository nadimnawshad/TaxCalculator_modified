...
<section class="text-center">
	<form action='DeleteUser.php' method='DELETE' class='form_style' >
		<label>* User Name : </label><br>
        <input type='text' style="width: 15%;" name='userName' id='userName' placeholder='User Name' >
        <p id='phoneValidation' class='errorMsg'></p>
		<input type="submit" value="Delete" class="btn button col-lg-1"
       style="padding: 1% 1%; margin: 2%;" onclick ="deleteUser()" />
    </form>
	<span class="line"></span>
</section>
